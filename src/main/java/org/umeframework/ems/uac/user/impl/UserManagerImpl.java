...
public class UserManagerImpl extends BaseDBComponent implements UserManager, MessageConst {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.umeframework.ems.uac.user.UserManager#changePassword(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.umeframework.ems.uac.user.UserManager#createUser(org.umeframework.ems.uac.entity.UmeUserDto)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.umeframework.ems.uac.user.UserManager#updateUser(org.umeframework.ems.uac.entity.UmeUserDto)
	 */
	@Override
