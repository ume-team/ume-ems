...
/**
 * Entity class map to table "UME自增长序列管理表"
 *
 * @author ume-team
 */
@Entity
@Table(name="UME_SEQ")
@TableDesc(label="UME自增长序列管理表")
public class UmeSeqDto extends TableEntity implements Serializable {
   /**
    ...
    */
     ...
     * @return
     */
    public UmeSeqDto copyFrom(
            Property... selectProperties) {
        if (selectProperties == null) {
            return null;
        }
        UmeSeqDto newInstance = new UmeSeqDto();
    ...
    public static class SQLID {
        public static final String INSERT = "org.umeframework.ems.uac.entity.UME_SEQ_INSERT"; 
        public static final String UPDATE = "org.umeframework.ems.uac.entity.UME_SEQ_UPDATE"; 
        public static final String SMART_UPDATE = "org.umeframework.ems.uac.entity.UME_SEQ_SMART_UPDATE"; 
        public static final String DELETE = "org.umeframework.ems.uac.entity.UME_SEQ_DELETE"; 
        public static final String FIND = "org.umeframework.ems.uac.entity.UME_SEQ_FIND"; 
        public static final String FIND_FOR_UPDATE = "org.umeframework.ems.uac.entity.UME_SEQ_FIND_FOR_UPDATE"; 
        public static final String SEARCH = "org.umeframework.ems.uac.entity.UME_SEQ_SEARCH"; 
        public static final String LIKE_SEARCH = "org.umeframework.ems.uac.entity.UME_SEQ_LIKE_SEARCH"; 
        public static final String DYNA_SEARCH = "org.umeframework.ems.uac.entity.UME_SEQ_DYNA_SEARCH"; 
        public static final String COUNT = "org.umeframework.ems.uac.entity.UME_SEQ_COUNT";
    } 
     ...
     */
    public static String TableName = "UME_SEQ";
