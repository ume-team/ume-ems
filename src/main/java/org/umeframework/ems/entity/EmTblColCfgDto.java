...
/**
 * Data transfer object mapping to table "EM实体属性配置表"
 *
...
public class EmTblColCfgDto extends TableEntity implements Serializable, Comparable<EmTblColCfgDto> {
   /**
    ...
    */
    ...
    public static class SQLID {
        public static final String INSERT = "TBL.EM_TBL_COL_CFG_INSERT"; 
        public static final String UPDATE = "TBL.EM_TBL_COL_CFG_UPDATE"; 
        public static final String SMART_UPDATE = "TBL.EM_TBL_COL_CFG_SMART_UPDATE"; 
        public static final String DELETE = "TBL.EM_TBL_COL_CFG_DELETE"; 
        public static final String FIND = "TBL.EM_TBL_COL_CFG_FIND"; 
        public static final String FIND_FOR_UPDATE = "TBL.EM_TBL_COL_CFG_FIND_FOR_UPDATE"; 
        public static final String SEARCH = "TBL.EM_TBL_COL_CFG_SEARCH"; 
        public static final String LIKE_SEARCH = "TBL.EM_TBL_COL_CFG_LIKE_SEARCH"; 
        public static final String DYNA_SEARCH = "TBL.EM_TBL_COL_CFG_DYNA_SEARCH"; 
        public static final String COUNT = "TBL.EM_TBL_COL_CFG_COUNT";
    } 
    ...
    public static class TableName {
        public static final String EM_TBL_COL_CFG = "EM_TBL_COL_CFG";
    }
